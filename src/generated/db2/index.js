...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\QA\\Angular Project\\ProMen\\project-management-api\\src\\generated\\db2",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\QA\\Angular Project\\ProMen\\project-management-api\\prisma\\schema2.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
...
path.join(process.cwd(), "src/generated/db2/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/generated/db2/schema.prisma")
