...
import { getFinishGoodWithPlan, getFinishGoodWithPlanKjy } from '@/services/get-finish-good';
import { allLines, allLinesKjy } from '@/constants';
    ...
    try {
      ...
      if (unit === 'monthly') {
        ...
        for (let i = 0; i < weeks.length; i++) {
          ...
          const combined = await getFinishGoodWithPlanKjy(start, end);
      ...
      const combined = await getFinishGoodWithPlanKjy(startDate, endDate);
